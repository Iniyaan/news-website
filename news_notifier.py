...
# One or more keywords to search for. Example: ["electric vehicles", "solar energy"]
KEYWORDS = ["your keyword here"]

# OPTIONAL: limit results to one or more websites. Leave as "" or [] to search all of Google News.
# Single site:  SITE = "thehindu.com"
# Multiple:     SITE = ["thehindu.com", "timesofindia.indiatimes.com"]
SITE = []
